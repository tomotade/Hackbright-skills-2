...
class Employee {
  ...
  // Example usage:
  const employee1 = new Employee("Tade", "Monday and Wednesday");
  const employee2 = new Employee("Taiwo", "Tuesday and Thursday");
  
  employee1.getSchedule(); 
  employee2.getSchedule(); 
...
class Manager extends Employee {
    constructor(name, shifts, employees) {
      ...
      // Additional property for Manager class
...
// Calling the getEmployees method on the manager variable
...
// Adding a new employee to the manager's list
...
// Calling the getEmployees method to confirm the addition of a new employee
manager.getEmployees(); 
